    ...
    return (
        <>
            <form className={styles.form} onSubmit={tradeNow} >
                ...
                <input className={styles.input} type="number" name='tokenTrade' min={0} max={2} defaultValue={0} />

                <label>Which token do you want to receive?</label>
                <input className={styles.input} type="number" name='tokenReceive' min={0} max={2} defaultValue={0} />

                <label>Quantity</label>
                <input className={styles.input} type="number" name='quantity' min={1} defaultValue={1} />

                <button className={styles.buttonTrade} type='onSubmit'>Trade Now</button>
